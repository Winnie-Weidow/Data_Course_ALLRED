...
First, I will load my data and visualize it.    
...
Now I am going to change the admit column from numeric to logical and find the best model using stepAIC().
...
full_model <- glm(data = grad_dat,
                  formula = admit ~ gre*gpa*rank,#do all the possibilities in a full model.
                  family = 'binomial')
